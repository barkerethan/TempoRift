 ...
 * This file demonstrates how to integrate Temporift with a web frontend
 */

// For React/Vue/Angular applications
export class TemporiftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new TemporiftClient(provider, contractAddress);
